...
| <a name="provider_lacework"></a> [lacework](#provider\_lacework) | 1.4.0 |
...
| <a name="output_network_name"></a> [network\_name](#output\_network\_name) | The network name for Agentless Workload Scanning resources. |
| <a name="output_prefix"></a> [prefix](#output\_prefix) | Prefix used to add uniqueness to resource names. |
| <a name="output_project_filter_list"></a> [project\_filter\_list](#output\_project\_filter\_list) | A list of projects to include/exclude for integration. |
